...
(async function makeTestData() {
  try {
    ...
    const positions = [
      positionCreator(12.57, 55.62, team1.userName, team1.name, true),
      positionCreator(12.58, 55.62, team2.userName, team2.name, true),
      positionCreator(12.59, 55.62, team3.userName, team3.name, true),
